...
import {
  ...
  PhoneCall, ChevronDown, ChevronUp, Wifi, BookOpen, QrCode
} from "lucide-react";
            ...
            <div key={group.label} className="mb-1">
              {!collapsed && group.label && (
                <button
                  ...
                  className="flex items-center justify-between w-full px-2 py-1.5 rounded text-[10px] font-bold uppercase tracking-widest text-sidebar-foreground/40 hover:text-sidebar-foreground/60 transition-colors"
                >
